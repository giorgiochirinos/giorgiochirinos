...
let videoElem = null;
let track = null;
column = document.createElement("card-v1-component");
column.dataset.id = `1`;
column.dataset.ch_title = `グローバルニュース DAILY BRIEF supported by GRIC2024`;
column.dataset.ch_image_url = `https://static.sonicbowl.cloud/img/podcast/5f943cf5-7d2c-4349-9ed6-0db8b1522437-20241013235131.jpg`;
column.dataset.ch_link = `https://spinear.com/original-podcasts/daily-brief/`;
column.dataset.ch_category = `News`;
column.dataset.ch_lang = `ja`;
column.dataset.ch_owner_name = `SPINEAR`;
column.dataset.ch_owner_email = `info@spinear.com`;
column.dataset.ch_copyright = `SPINEAR`;
column.dataset.it_title = `【9月12日】ハイチ移民が変えるアメリカ大統領選の議論 / OpenAI、評価額1500億ドルで50億ドルの資金調達へ`;
column.dataset.it_descr = `<p>■DAILY BRIEF BILINGUALはこちらから<br></p><p><a href="https://sbwl.to/dbb-smry" target="_blank">https://sbwl.to/dbb-smry</a>&nbsp;</p><p><br></p><p><br></p><p>9月12日、世界で今起きていること</p><p><br>【ニュースソース】</p><p><br>1.ハイチ移民が変えるアメリカ大統領選の議論</p><p><a href="https://x.gd/V06oI">https://x.gd/V06oI</a></p><p><br>2.ニューヨーク市で9月11日の追悼式典が開催、23年目の祈り</p><p><a href="https://x.gd/BazR5">https://x.gd/BazR5</a></p><p><br>3.OpenAI、評価額1500億ドルで50億ドルの資金調達へ</p><p><a href="https://x.gd/U3tlc">https://x.gd/U3tlc</a></p><p><br>4.ドイツの国境管理強化に近隣国が反発</p><p><a href="https://x.gd/GJb9k">https://x.gd/GJb9k</a></p><p><br>5. エア・カナダ労働紛争、政府介入を企業が要請</p><p><a href="https://x.gd/NFsts">https://x.gd/NFsts</a></p><p><br>6.最高裁判決後、ハーバード大学の黒人学生が減少</p><p><a href="https://x.gd/SZAmt">https://x.gd/SZAmt</a></p><p><br></p><p><br></p><p><br></p><p>■SPINEAR Contact</p><p><a href="https://sbwl.to/4hmBDrr" target="_blank">https://sbwl.to/4hmBDrr</a></p>`;
column.dataset.it_link = `https://spinear.com/original-podcasts/daily-brief/episodes/daily-brief-24-0912/`;
column.dataset.it_media_type = `audio`;
column.dataset.it_media_url = `https://feed.sonicbowl.cloud/audio/d6d2d648-f292-48bc-b1f3-6f8cb3af0278/audio.mp3?updated=1726098614`;
column.dataset.it_pub_date = `2024-09-12`;
column.dataset.it_duration = `00:08:39.000`;
column.id = `1`;
videoElem = document.createElement('VIDEO');
videoElem.id = `1`;
videoElem.src = `https://feed.sonicbowl.cloud/audio/d6d2d648-f292-48bc-b1f3-6f8cb3af0278/audio.mp3?updated=1726098614`;
videoElem.setAttribute("slot", "vid")
//videoElem.controls = true;
column.dataset.caption_language += `ja,`;
...
column.dataset.caption_language += `sp,`;
...
videoElem.style.display = "none"; //new
column.appendChild(videoElem); //new 
...
videoElem.setAttribute("slot", "vid")
//videoElem.controls = true;
column.dataset.caption_language += `en,`;
